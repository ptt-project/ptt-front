    ...
    <main className={`main ${styles.page}`}>
      ...
      <div className="page-content mb-9">
        <div className="container">
          <Row gutter={48}>
            <Col xl={6} lg={0}>
              <aside className="sidebar sidebar-fixed sticky-sidebar-wrapper home-sidebar">
                ...
                <div className="sidebar-content">
                  <ul className="menu vertical-menu category-menu mb-4">
                    <li><ALink href="/shop" className="menu-title"><i className="fas fa-user"/> บัญชีผู้ใช้</ALink></li>
                    <li key='home-sidebar-active'><ALink href="#">ข้อมูลส่วนตัว</ALink></li>
                    <li key='home-sidebar'><ALink href="#">ที่อยู่</ALink></li>
                  </ul>
                </div>
              </aside>
            </Col>
