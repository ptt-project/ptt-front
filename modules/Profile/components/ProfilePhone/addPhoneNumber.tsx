...
const AddPhoneNumber: FC<IProfilePhoneProps> = (props: IProfilePhoneProps) => {
  ...
  return (  
    <>  
      <Text>
        <h4 className={`text-center mb-5 ${styles.textEmailTitle}`}>{t('accountProfile.phone.titleAdd')}</h4>
      </Text>
        <Row gutter={[16, 8]}>
          <Col md={12} xs={12}>
